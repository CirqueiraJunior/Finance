...
def test_cashflow_page_contains_unified_table_and_seven_cards(qtbot):
    ...
    assert page.cash_movement.text() == "R$ 0,0000"
...
def test_homologation_cards_use_correct_semantics(qtbot, db_session):
    ...
    assert page.applications_total.text() == "R$ 10.000,0000"
    assert page.redemptions_total.text() == "R$ 2.500,0000"
    assert page.operational_result.text() == "R$ 21.567,2684"
    assert page.cash_movement.text() == "R$ 14.067,2684"
    assert page.applied_balance.text() == "R$ 7.500,0000"
